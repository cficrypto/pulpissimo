...
# if {$rvcores ne ""} {
  ...
  add wave -group "CFI" $rvcores/if_stage_i/riscv_decrypt_i/decrypter/riscv_decrypt_inst/perm_state
  add wave -group "CFI" $rvcores/if_stage_i/riscv_decrypt_i/decrypter/riscv_decrypt_inst/perm_state_n
